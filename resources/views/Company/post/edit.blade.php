    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card card-primary">
                ...
                <div class="card-body">
                    <form action="{{ route('Company.post.update', ['id' => $post->id]) }}" method="POST"
                        ...
                        <div class="form-group">
                            ...
                            <input name="designation" type="text" class="form-control" value="{{ $post->designation }}">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <select id="inputLevel" class="form-control custom-select" name="level">
                                ...
                                <option value="intermediate" {{ $post->level == 'intermediate' ? 'selected' : '' }}>
                                    Intermediate
                                </option>
                        ...
                        <div class="form-group">
                            ...
                            <input name="experiance" type="text" class="form-control" value="{{ $post->experiance }}">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input name="created_by" type="integer" class="form-control" value="{{ $post->created_by }}">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input name="location" type="text" class="form-control" value="{{ $post->location }}">
                        </div>
